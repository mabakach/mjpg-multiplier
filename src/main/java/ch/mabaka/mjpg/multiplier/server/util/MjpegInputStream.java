package ch.mabaka.mjpg.multiplier.server.util;
 ...
 * 
 * This class is copied from @see https://github.com/sarxos/webcam-capture/blob/master/webcam-capture/src/main/java/com/github/sarxos/webcam/util/MjpegInputStream.java
 * 
